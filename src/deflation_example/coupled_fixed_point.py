...
Forward coupling selects coefficients in mass-weighted temperature coordinates.
Complete-field mixing applies them to temperature, velocity, and pressure.
Momentum acceleration selects coefficients in velocity coordinates. These
policies change the iteration and retain the original equation checks.
"""
